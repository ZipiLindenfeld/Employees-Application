...
@Component({
  ...
  styleUrl: './add-employee-dialog-component.component.scss'
})
export class AddEmployeeDialogComponent {
  ...
  constructor(private router: Router, private formBuilder: FormBuilder, private _acr: ActivatedRoute, public dialogRef: MatDialogRef<AddEmployeeDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
    ...
    this.employeeForm = new FormGroup({
      ...
      employeeIdentification: new FormControl(this.employee.employeeIdentification, [Validators.required, Validators.minLength(9), Validators.maxLength(9)]),
      ...
      startDate: new FormControl(this.isValidDate(this.employee.startDate) ? new Date(this.employee.startDate).toISOString().substring(0, 10) : '', [Validators.required]),
